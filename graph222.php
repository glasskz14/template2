...
<div id="printable">
  <font face = "verdana">
  <center><img src="images/11.svg" width="170" height="170"> <P><h5>ตารางเเสดงของเจอในเเต่ละปี</h5></center>
...
$query = "SELECT COUNT(found_id) AS totol, DATE_FORMAT(date, '%Y') AS date
  FROM founditem
 ...
 <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.6.0/Chart.bundle.js"></script>
  ...
  var myChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: 'รายงานภาพรวม แยกตามรายปี (สิ่งของ)',
              data: [<?php echo $totol;?>
              ],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
