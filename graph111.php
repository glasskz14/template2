...
<div id="printable">
  <font face = "verdana">
    <center><img src="images/11.svg" width="170" height="170"> <P><h5>ตารางเเสดงของหายในเเต่ละปี</h5></center>
...
$query = "SELECT COUNT(lost_id) AS totol, DATE_FORMAT(date, '%Y') AS date
  FROM lostitem
