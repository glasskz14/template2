...
<ul class="breadcrumb">
  ...
  <li><a href="found4.php">รายการของที่เจอ</a></li>
...
<body>
     <h2>ค้นหา</h2>
    <form action="lostseach.php" method="post" name="lostseach"/>
    <label>ค้นหา: </label><input type="text" size="40px" name="lostseach"/>
    <br>
    <center>
