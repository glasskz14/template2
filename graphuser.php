...
$query = "SELECT COUNT(found_id) AS totol, DATE_FORMAT(status, '%ยังไม่ไ้รับคืน') AS status
  FROM founditem
  GROUP BY DATE_FORMAT(status, '%ยังไม่ไ้รับคืน%)
  ";  
    ...
    <center>
      ...
      <tr>
        ...
        <th style="width: 15px;" align="center">ชื่อสิ่งของ</th>
          ...
          <tr>
            <center>
        <td style="width: 15px;"><?php echo $row['status'];?></a></td>
 ...
 <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.6.0/Chart.bundle.js"></script>
  ...
  var myChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              label: 'รายงานภาพรวม แยกตามรายวัน (สิ่งของ)',
              data: [<?php echo $totol;?>
              ],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
