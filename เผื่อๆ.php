...
<ul>
  ...
  <li style="float:right;"><a href="profile.php?user_id=<?php echo $row['user_id']; ?>">ข้อมูลส่วนตัว</a></li>
</ul>
</header>
...
<li style="float:right"><a href="fromupdatelost1.php?lost_id=<?php echo $rowlost['lost_id']; ?>">เเก้ไขข้อมุล</a></li>