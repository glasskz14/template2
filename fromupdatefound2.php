				...
				<!-- Header -->
					<header id="header">
						<div class="inner">
							...
							<!-- Logo -->
								<a href="indexwel.phph" class="logo">
...
<ul class="breadcrumb">
 <li><a href="indexwel.php">หน้าเเรก</a></li>
  ...
  <li style="float:right"><a href="fromupdatefound2.php?found_id=<?php echo $rowfound['found_id']; ?>">เเก้ไขข้อมุล</a></li>
								...
								<section>
									...
									<form method="post" action="updatefound1.php" enctype="multipart/form-data" id="form1">
										...
										<div class="4u 12u$(small)">
												<input type="radio" id="status_0" name="status" value="ยังไม่ได้รับคืน" <?php if ($rowfound['status']=='0') echo"checked"; ?> checked>
												<label for=status_0 >ยังไม่ได้รับคืน</label>											
												<input type="radio" id="status_1" name="status" value="ได้รับคืนเเล้ว" <?php if ($rowfound['status']=='1') echo"checked"; ?> >
