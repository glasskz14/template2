...
<ul class="breadcrumb">
  ...
  <li><a href="FromFound.php">เเจ้งรายการของที่เจอ</a></li>
</ul>
							
							<!-- Form -->
								<section>
									<h2>แบบฟอร์มข้อมูล (Form)</h2>
									<form method="post" action="foundinsert.php" enctype="multipart/form-data" id="form1">

										<div class="4u 12u$(small)">
												<input type="radio" id="status_0" name="status" value="ยังไม่ได้รับคืน" checked>
												<label for=status_0 >ยังไม่ได้รับคืน</label>	
									<form method="post" action="foundinsert.php" enctype="multipart/form-data" id="form1">										
												<input type="radio" id="status_1" name="status" value="ยังไม่ได้รับคืน">
