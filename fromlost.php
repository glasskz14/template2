...
<html>
	<head>
		<title>Fromlost เเจ้งรายการของหาย</title>
		<meta charset="utf-8" />
...
<ul class="breadcrumb">
  ...
  <li><a href="FromLost.php">เเจ้งรายการของที่หาย</a></li>
							...
							<!-- Form -->
								<section>
									...
									<form method="post" action="lostinsert.php" enctype="multipart/form-data" id="form1">
